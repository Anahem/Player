...
A self-hosted Steam profile analyser. Look up any public Steam profile, browse the full game library, discover unplayed and barely-started games, and view detailed playtime stats and reports. Runs locally with no cloud and no account required.
...
- **Game suggestions**: shuffled picks from your backlog split into Never played, Barely started (under 1h), and In progress (1-10h)
- **Stats and reports**: total playtime, played vs unplayed counts, average per game, top-10 chart, and playtime distribution breakdown
